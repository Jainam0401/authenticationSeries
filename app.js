...
app.get("/auth/google/secrets", 
  ...
  function(req, res) {
    // Successful authentication, redirected to secrets.
...
console.log(req.user.id);
    ...
    user.findById(req.user.id,function (err,foundResults) {
        if(err){
            console.log(err);
        }else{
            foundResults.secret = submittedSecret;
            foundResults.save(function () {
                res.redirect("/secrets")
            })
        }
